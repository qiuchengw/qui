...
public:
  ...
  */
  virtual int Compare(const wxString& text1, const wxString& text2) { return text1.Compare(text2); }
};
...
class  wxSQLite3IntegerCollection : public wxSQLite3NamedCollection
{
public:
  /// Constructor
...
class  wxSQLite3StringCollection : public wxSQLite3NamedCollection
{
public:
  /// Constructor
...
/**
*/
class  wxSQLite3RegExpOperator : public wxSQLite3ScalarFunction
{
public:
  /// Constructor
