...
public:
	...
	CTextFileWrite(QFile* file, TEXTENCODING type=ASCII);
#endif
	~CTextFileWrite();
...
#if PEK_TX_TECHLEVEL == 2
	bool ReadLine(CStdString& line);
	bool Read(CStdString& all, const CStdString newline=_T("\r\n"));
#endif
