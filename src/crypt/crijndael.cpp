...
int CRijndael::init(Mode mode,Direction dir,const RD_UINT8 * key,KeyLength keyLen,RD_UINT8 * initVector)
{
	// Not initialized yet
	m_state = Invalid;
...
int CRijndael::blockEncrypt(const RD_UINT8 *input,int inputLen,RD_UINT8 *outBuffer)
{
	int i, k, numBlocks;
...
int CRijndael::padEncrypt(const RD_UINT8 *input, int inputOctets, RD_UINT8 *outBuffer)
{
...
int CRijndael::blockDecrypt(const RD_UINT8 *input, int inputLen, RD_UINT8 *outBuffer)
{
	int i, k, numBlocks;
	RD_UINT8 block[16], iv[4][4];
...
int CRijndael::padDecrypt(const RD_UINT8 *input, int inputOctets, RD_UINT8 *outBuffer)
{
	int i, numBlocks, padLen;
	RD_UINT8 block[16];
	RD_UINT32 iv[4];
...
void CRijndael::keySched(RD_UINT8 key[_MAX_KEY_COLUMNS][4])
{
	int j,rconpointer = 0;
...
void CRijndael::encrypt(const RD_UINT8 a[16], RD_UINT8 b[16])
{
	int r;
	RD_UINT8 temp[4][4];
...
void CRijndael::decrypt(const RD_UINT8 a[16], RD_UINT8 b[16])
{
	int r;
	RD_UINT8 temp[4][4];
