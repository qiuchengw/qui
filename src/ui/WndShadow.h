...
public:
	...
	inline BOOL IsValid()const { return ::IsWindow(m_hWnd); }
protected:
...
public:
	...
	LRESULT ParentProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam);
...
protected:
	...
	void Show(HWND hParentWnd,BOOL bBeingShow=FALSE);
};
