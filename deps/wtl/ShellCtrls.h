...
class CShellTreeCtrl :
   public CWindowImpl< CShellTreeCtrl, CTreeViewCtrl, CShellTreeTraits >,
   public CShellBaseCtrl< CShellTreeCtrl, HTREEITEM >
{
public:
   typedef CWindowImpl< CShellTreeCtrl, CTreeViewCtrl, CShellTreeTraits > parentClass;
...
typedef CWinTraitsOR<LVS_SINGLESEL | LVS_SHOWSELALWAYS | LVS_AUTOARRANGE 
                    | LVS_NOCOLUMNHEADER | WS_BORDER | WS_TABSTOP, 
                    LVS_EX_DOUBLEBUFFER> CShellListTraits;
#else
typedef CWinTraitsOR<LVS_SINGLESEL | LVS_SHOWSELALWAYS | LVS_AUTOARRANGE 
                    | LVS_NOCOLUMNHEADER | WS_BORDER | WS_TABSTOP> CShellListTraits;
#endif

class CShellListCtrl :
   public CWindowImpl< CShellListCtrl, CListViewCtrl, CShellListTraits >,
   public CShellBaseCtrl< CShellListCtrl >
{
public:
   typedef CWindowImpl< CShellListCtrl, CListViewCtrl, CShellListTraits > parentClass;
...
class CAeroShellTreeCtrl : 
    public aero::CCtrlImpl<CAeroShellTreeCtrl, CShellTreeCtrl,true>
{
public:
...
class CAeroShellListCtrl : 
    public aero::CCtrlImpl<CAeroShellListCtrl, CShellListCtrl,true>
{
public:
